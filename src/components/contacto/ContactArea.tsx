               ...
               <div className="col-xxl-8 col-xl-8 col-lg-8">
                  <div className="contact-page-form-area">
                     <div className="title-box mb-40 wow fadeInLeft" data-wow-delay=".5s">
                        <span className="section-sub-title">Hablemos ahora</span>
                        <h3 className="section-title mt-10">Contáctanos y recibe atención personalizada</h3>
                     </div>
