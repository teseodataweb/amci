                     ...
                     <div className="blog-style-one">
                        ...
                        <div className="blog-content">
                           <div className="post-meta">
                              <span className="p-relative"><Link to="/blog-details"><i className="fal fa-user"></i>{item.date}</Link></span>
                              <span className="p-relative"><Link to="/blog-details"><i className="fal fa-calendar-alt"></i>{item.date}</Link></span>
                           </div>
                           <hr />
                           <h5 className="blog-title mb-30"><Link to="/blog-details">{item.title}</Link></h5>
