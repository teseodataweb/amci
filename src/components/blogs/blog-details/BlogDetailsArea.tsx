            ...
            <div className="row">
               <div className="col-xxl-8 col-xl-8 col-lg-8">
                  <figure className="blog-thumb w-img">
                     <img src="/assets/imgs/blog/blog-details-1.jpg" alt="" />
                  </figure>
                  <ul className="blog-post-meta mb-20 mt-40">
                     <li><Link to="#"><i className="fal fa-user"></i>By Admin</Link></li>
                     <li><Link to="#"><i className="fal fa-calendar-days"></i>28 Nov, 2023</Link></li>
                     <li><Link to="#"><i className="fal fa-tag"></i>Roof Renovation</Link></li>
                  </ul>
                  <hr />
                  <h3 className="blog-details-title mb-30 mt-20"><Link to="#">{title_1}</Link></h3>
                  ...
                  <div className="row mb-40">
                     <div className="col-lg-6">
                        <figure className="w-img">
                           <img src="/assets/imgs/blog/blog-details-2.jpg" alt="" />
                        </figure>
                     </div>
                     <div className="col-lg-6">
                        <figure className="w-img">
                           <img src="/assets/imgs/blog/blog-details-3.jpg" alt="" />
                        </figure>
                     </div>
                  </div>
