               ...
               <div className="col-xxl-7">
                  <div className="banner-3-content p-relative bg-color-1">
                     ...
                     <div className="banner-area-2 img-custom-anim-left animated" data-wow-delay="2000ms">
                        <span className="p-relative banner-sub-title no-border">Herramientas Digitales</span>
                        <h1 className="banner-title">Optimiza tus procesos con software especializado</h1>
                        <p className="banner-text">Desde el diseño de mezclas hasta el control de calidad, nuestros sistemas digitales están pensados para mejorar la eficiencia y trazabilidad en cada etapa del proceso del concreto.</p>
                        <div className="banner-btn-area-2">
                           <Link className="primary-btn-1 btn-hover" to="/services">
                              Solicita una demo &nbsp; | <i className="icon-right-arrow"></i>
