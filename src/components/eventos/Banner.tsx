               ...
               <div className="col-xxl-7">
                  <div className="banner-3-content p-relative bg-color-1">
                     ...
                     <div className="banner-area-2 img-custom-anim-left animated" data-wow-delay="2000ms">
                        <span className="p-relative banner-sub-title no-border">EVENTOS AMCI</span>
                        <h1 className="banner-title">Conectamos al gremio con ideas que transforman</h1>
                        <p className="banner-text">Participa en nuestras jornadas técnicas, foros nacionales y eventos regionales diseñados para fortalecer la industria concretera independiente. Desde capacitaciones hasta networking de alto valor, cada encuentro es una oportunidad para crecer.</p>
                  ...
                  <div className="banner-3-image-area p-relative" style={{ backgroundImage: `url(/assets/imgs/banner/banner-4.jpg)` }}>
                     <div className="banner-3-experience">
                        ...
                        <div className="content">
                           ...
                           <p className="text-white">años impulsando la comunidad concretera</p>
                        </div>
                     </div>
